...
xst -ifn xst.scr
move lcd_spi_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\lcd_spi_clk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc lcd_spi_clk_exdes.ucf lcd_spi_clk_exdes

echo 'Running map'
map -timing -pr b lcd_spi_clk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm lcd_spi_clk_exdes -w routed.ncd routed.v
cd ..
